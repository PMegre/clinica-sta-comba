<?php /* Template Name: Página de dentária */ get_header(); ?>
                  ...
                  <div class="row">
                     <div class="col-sm-4">
                        <div class="hidden-xs-down">
                           <h3 class="big">MEDICINA DENTÁRIA</h3>
                           <nav>
                        ...
                        <div class="mt-auto">
                           <div class="row">
                              <div class="col-12">
                                 ...
                                 <p>Explique-nos o seu caso através do <a href="/fale-comigo-dr-pedro-santa-comba">Formulário de Contacto</a> e ser-lhe-á indicado um intervalo de valores em que poderá ficar a resolução do seu problema.</p>
                              </div>
                           </div>
                        </div>
                     </div>
