<?php /* Template Name: Página de cirurgia plástica */ get_header(); ?>
      ...
      <?php if (have_posts()): while (have_posts()) : the_post(); ?>
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
               <div class="page-contents">
                  <div class="row">
                     <div class="col-sm-4">
                        <div class="hidden-xs-down">
                           <h3 class="big">CIRURGIA PLÁSTICA, RECONSTRUTIVA E ESTÉTICA</h3>
                           <nav>
                              <h5>TOXINA BOTOLIMICA TIPO A</h5>
		          ...
		          'items_wrap'     => '<form><select class="categories-mobile" onchange="if (this.value) window.location.href=this.value">%3$s</select></form>',
	) ); ?>
                           </nav>
                        </div>
                     </div>
                        ...
                        <div class="mt-auto">
                           <div class="row">
                              <div class="col-12">
                                 ...
                                 <p>Explique-nos o seu caso através do <a href="/fale-comigo-dr-antonio-santa-comba">Formulário de Contacto</a> e ser-lhe-á indicado um intervalo de valores em que poderá ficar a resolução do seu problema.</p>
                                 <img class="hospital-lapa" src="<?php echo get_template_directory_uri(); ?>/img/hospital-lapa-01.svg">
                                 <p class="lapa-txt">Cirurgias realizadas no Hospital da Lapa.</p>
                              </div>
                           </div>
                        </div>
                     </div>
